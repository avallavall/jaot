...
HiGHS, CBC, GLPK and JAOS under the terms the product itself imposes: the same time
...
Run it inside the comparison worker, which is the only image carrying all five
...
SOLVERS = ["scip", "highs", "cbc", "glpk", "jaos"]
