...
> Quick overview of the contexts that make up JAOT (8 identified; BC3 Billing was removed entirely by ADR-008). The authoritative source is [`docs/BOUNDED_CONTEXTS.md`](../../BOUNDED_CONTEXTS.md); this file is a single-screen view meant for understanding at a glance.
...
flowchart LR
    ...
    Automation -->|trigger_tasks → solve| Solver
...
7. **Automation** — orchestrates the remaining domains, goes last.
