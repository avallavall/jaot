...
- [`04-database/01-erd-core.md`](./04-database/01-erd-core.md) — Identity + Model + Execution
...
- [`07-use-cases/04-marketplace-buy.md`](./07-use-cases/04-marketplace-buy.md) — free marketplace activation
