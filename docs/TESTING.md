...
| | |
|---|---|
| Backend tests | **5,912** collected across 270 files. That is 3,821 test functions — 1,106 written at module level and 2,715 as methods on test classes — plus what parametrization adds |
