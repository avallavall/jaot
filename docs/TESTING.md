...
| | |
|---|---|
| Backend tests | **5,937** collected across 270 files. That is 3,845 test functions — 1,119 written at module level and 2,726 as methods on test classes — plus what parametrization adds |
