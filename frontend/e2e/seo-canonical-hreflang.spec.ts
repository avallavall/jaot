...
// Pages cover one representative per page TYPE: home (root), static (contact),
    ...
    for (const locale of LOCALES) {
      test(
        ...
        async ({ page }) => {
          ...
          // EN: https://jaot.io/contact — ES: https://jaot.io/es/contact (NOT https://jaot.io/contact).
          ...
          // e.g., on /es/contact the hreflang="ca" MUST be https://jaot.io/ca/contact.
