 ...
 *
 * Authors + solves a JModel that carries index structure. JModel used to sit behind
 * a JAOT_DSL flag this spec had to switch on and restore; the flag is gone.
 */
...
test.describe("Studio — post-solve analysis page (v3.1 A1-A5)", () => {
