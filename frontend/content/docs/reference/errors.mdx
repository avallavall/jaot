...
| "Insufficient credits" | Organization usage quota is exhausted | Wait for the quota to reset, or ask your org admin (self-hosters can raise the quota cap) |
...
| **402** | Usage quota exhausted — wait for it to reset or raise the cap |
