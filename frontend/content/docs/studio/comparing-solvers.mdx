...
**Times are comparable inside one comparison and nowhere else.** The machine that produced them is stated above the table. A comparison you ran last month, on a machine under a different load, is not a fair opponent for one you run today.
