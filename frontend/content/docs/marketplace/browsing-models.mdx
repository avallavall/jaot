...
The marketplace is free — activating a model costs nothing, and running it costs nothing either. Fair use is enforced through per-organization rate limits and solve caps (see [Usage Limits](/docs/reference/usage-limits)).
