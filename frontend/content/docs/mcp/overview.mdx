...
|------|------|-------------|
| `solve_problem` | Yes | Solve an optimization problem defined as variables, constraints, and an objective. Optionally choose a solver (`scip`, `highs`, `cbc`, `glpk`, `jaos`) or `auto` routing |
