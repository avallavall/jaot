...
describe("getFlatPages", () => {
  it("returns all leaf pages with guides included", () => {
    ...
    // 3 getting-started + 5 ai-builder + 2 marketplace + 1 mcp + 11 api + 2 reference + 1 studio + 35 guides = 60 (ADR-008: credits-billing removed, rate-limits-credits -> usage-limits)
